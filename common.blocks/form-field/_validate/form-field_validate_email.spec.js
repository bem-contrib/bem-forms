...
describe('form-field_validate_email', function() {
    ...
    it.skip('should set invalid mod to hidden after value change with invalid email');
    ...
    it.skip('should set invalid mod to input after value change with invalid email');
    ...
    it.skip('should set invalid mod to textarea after value change with invalid email');
    ...
    it.skip('should set invalid mod to select after value change with invalid email');
    ...
    it.skip('should set invalid mod to empty checkbox after value change with invalid email');
    ...
    it.skip('should set invalid mod to checkbox-group after value change with invalid email');
    ...
    it.skip('should set invalid mod to radio after value change with invalid email');
    ...
    it.skip('should set invalid mod to radio-group after value change with invalid email');
